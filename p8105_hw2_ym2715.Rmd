...
```{r read and clean data for Problem1}
...
```{r Read and Clean Mr. Trash Wheel dataset}
...
```{r Read and clean precipitation data for 2016 and 2017}
...
```{r Combine the 2016 & 2017 datasets}
...
```{r calculate total prec in 2017}
  sum(prec_2017_df$total)
```

the median number of sports balls in a dumpster in 2016 is 26

```{r calculate median of sports balls in 2016}
...
```{r read and clean data from BRFSS}
